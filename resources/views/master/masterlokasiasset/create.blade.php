...
<div class="card shadow mb-4" data-aos="fade-up" data-aos-delay="50">
  <div class="card-header py-3 px-sm-3 px-2">
    <h6 class="m-0 font-weight-bold text-primary" data-aos="fade-right" data-aos-delay="100">Tambah Lokasi Aset</h6>
  </div>
  <div class="card-body px-sm-3 px-2">
    <form action="{{ route('master_lokasiasset.store') }}" method="POST" enctype="multipart/form-data" class="col-lg-6 px-0">
      @csrf
      <label for="mla_lokasi_asset" class="form-label">Nama Lokasi Aset</label>
